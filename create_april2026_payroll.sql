-- ============================================================
-- GOODHR Payroll: สร้างงวดเมษายน 2026
-- Generated: 2026-03-23
--
-- วิธีใช้:
-- 1) รัน SQL นี้ใน Supabase SQL Editor → สร้างงวด April
-- 2) ไปที่หน้า admin เงินเดือน → เลือกงวดเมษายน → กด "คำนวณทั้งหมด"
...
-- ============================================================
-- STEP 0: ลบข้อมูลเดือนเมษายนที่มีอยู่ (ถ้ามี)
-- ============================================================

DELETE FROM payroll_records WHERE year = 2026 AND month = 4;
DELETE FROM payroll_periods WHERE year = 2026 AND month = 4;

-- ============================================================
-- STEP 1: สร้าง payroll_periods สำหรับ เมษายน 2026 (4 บริษัท)
--         งวด: 22 มี.ค. 2026 → 21 เม.ย. 2026
--         จ่าย: 25 เม.ย. 2026
-- ============================================================
...
VALUES (gen_random_uuid(), 'a684555a-e44d-4441-9af8-521115cd000a', 2026, 4, 'เมษายน 2026', '2026-03-22', '2026-04-21', '2026-04-25', 'draft');

-- Top One Service Co., Ltd.
INSERT INTO payroll_periods (id, company_id, year, month, period_name, start_date, end_date, pay_date, status)
VALUES (gen_random_uuid(), '3d383dcd-9544-4b38-8cff-a37b69b9db57', 2026, 4, 'เมษายน 2026', '2026-03-22', '2026-04-21', '2026-04-25', 'draft');

-- PTC
INSERT INTO payroll_periods (id, company_id, year, month, period_name, start_date, end_date, pay_date, status)
VALUES (gen_random_uuid(), 'a24d6342-8720-42c7-bb8a-5932169274bf', 2026, 4, 'เมษายน 2026', '2026-03-22', '2026-04-21', '2026-04-25', 'draft');

-- RABBIT
INSERT INTO payroll_periods (id, company_id, year, month, period_name, start_date, end_date, pay_date, status)
VALUES (gen_random_uuid(), '03d7debf-d6d9-4b6b-afde-e8e91a3758e5', 2026, 4, 'เมษายน 2026', '2026-03-22', '2026-04-21', '2026-04-25', 'draft');

-- ============================================================
-- STEP 2: สร้าง payroll_records ตั้งต้นจาก salary_structures
...
JOIN payroll_periods pp
  ON pp.company_id = e.company_id AND pp.year = 2026 AND pp.month = 4
LEFT JOIN LATERAL (
...
--   → เลือกแต่ละบริษัท → เลือกงวดเมษายน 2026
--   → กดปุ่ม "คำนวณทั้งหมด"
