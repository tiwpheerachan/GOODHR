  ...
  return (
    <div className="p-4 pb-28 space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-lg font-black text-slate-800">ประเมินทดลองงาน</h1>
      ...
      {employee && (
        <div className="card flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-bold text-slate-800">{employee.first_name_th} {employee.last_name_th}</p>
      ...
      <div className={`card flex items-center justify-between ${gradeConf.bg} ring-1 ${gradeConf.ring}`}>
        ...
        <div className="text-right">
          <p className="text-xs text-slate-500">น้ำหนักรวม</p>
            ...
            <div key={idx} className="card space-y-3">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {item.is_mandatory && <span className="text-[9px] font-bold text-rose-600 bg-rose-50 px-1.5 py-0.5 rounded">บังคับ</span>}
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-md overflow-hidden">
            ...
            <div className="px-6 py-5 space-y-3">
              <h3 className="text-lg font-black text-slate-800 text-center">ยืนยันส่งผลประเมิน?</h3>
              <p className="text-sm text-slate-500 text-center">
                {employee?.first_name_th} {employee?.last_name_th} · {ROUND_LABELS[round]}
              </p>
              <p className="text-[11px] text-amber-600 text-center">ข้อมูลจะส่งให้ HR ตรวจสอบก่อนแจ้งพนักงาน</p>
            </div>
            <div className="px-6 pb-6 flex gap-3">
              <button onClick={() => setShowConfirm(false)} className="flex-1 py-3 rounded-2xl bg-slate-100 font-bold text-sm">ยกเลิก</button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-3xl w-full max-w-sm overflow-hidden">
            <div className="bg-emerald-50 px-6 py-5 text-center">
              ...
              <p className="text-lg font-black text-slate-800">ส่งผลประเมินเรียบร้อย</p>
            </div>
            <div className="px-6 py-5 space-y-3">
              ...
              <div className="bg-blue-50 rounded-xl px-4 py-3">
                ...
                <p className="text-[11px] text-blue-600 mt-0.5">เมื่อ HR อนุมัติแล้ว พนักงานจะเห็นผลประเมิน</p>
              </div>
            </div>
            <div className="px-6 pb-6">
              <button onClick={() => { setShowSuccess(false); router.push("/manager/probation-eval") }}
                className="w-full py-3 rounded-2xl bg-rose-600 text-white font-bold text-sm">กลับหน้ารายชื่อ</button>
            </div>
          </div>
        </div>
      )}
