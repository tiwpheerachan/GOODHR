"use client"
/**
 * แอดมิน — สินค้าสแกนไม่เจอ (scan_misses)
 *   บาร์โค้ด/ซีเรียลที่พนักงานสแกนแล้วไม่มีในระบบ → เอาไปเติม master data
 *   สำคัญกับยอดขาย: รู้ว่าสินค้าไหนขายแต่ยังไม่มีข้อมูล
 */
...
export default function ScanMissesPage() {
  const { t } = useLanguage()
    ...
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-black text-slate-800">{t("admin.nav.scan_misses")}</h1>
            <p className="text-xs text-slate-400">บาร์โค้ด/ซีเรียลที่สแกนแล้วไม่มีในระบบ · เอาไปเติมข้อมูลสินค้า</p>
          </div>
        </div>
      ...
      {/* stat */}
      <div className="mb-5 rounded-2xl border border-amber-100 bg-amber-50/60 p-5 flex items-center justify-between">
        <div>
          <p className="text-[13px] font-bold text-amber-700">รายการค้างเติมข้อมูล</p>
        ...
        <PackageSearch size={40} className="text-amber-300" />
      </div>
