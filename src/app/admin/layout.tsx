...
import {
  ...
  Network, ClipboardCheck, Megaphone, MessageCircle, ScrollText, Shield, Package, Table2, PieChart, Sparkles,
} from "lucide-react"
...
const SIDEBAR = [
  ...
  { href: "/admin/work-record",         icon: Sparkles,        label: "บันทึกการ Pro Max", badge: null as string|null },
