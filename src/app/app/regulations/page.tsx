...
const SIG_SHD: Sig = { src: "/regulations-sig/sig-shd.png", company: "SHD Technology", name: "" }
const SIG_RABBIT: Sig = { src: "/regulations-sig/sig-rabbit.jpg", company: "Rabbit + TopOne", name: "" }
const SIG_HASHTAG: Sig = { src: "/regulations-sig/sig-hashtag.png", company: "Hashtag", name: "" }
