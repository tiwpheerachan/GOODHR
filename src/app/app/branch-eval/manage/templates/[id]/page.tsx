...
export default function TemplateEditorPage() {
  ...
  return (
    <div className="p-4 lg:p-6 max-w-4xl mx-auto space-y-3 pb-32">
      <Link href="/app/branch-eval/manage/templates" className="inline-flex items-center gap-1 text-sm text-slate-400 hover:text-slate-700">
