...
import {
  ArrowLeft, BarChart3, TrendingUp, RefreshCw, Loader2,
  AlertTriangle, Award,
} from "lucide-react"
    ...
    <div className="p-4 lg:p-6 max-w-6xl mx-auto space-y-4 pb-32">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-slate-400 text-sm">ข้อมูล {filtered.length} ฟอร์ม ({days} วันย้อนหลัง) — สาขาที่ฉันดูแล</p>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden">
            <p className="text-sm font-black px-4 py-3 border-b border-slate-100 text-slate-800">สาขาที่ฉันดูแล ({byBranch.length})</p>
