...
--
--   ⚠️  ปรับช่วงวันที่ตรงตัวแปร v_period_start / v_period_end
--   ตอนนี้ตั้งเป็นรอบเงินเดือนปัจจุบัน 22 พ.ค. – 21 มิ.ย. 2026
-- ════════════════════════════════════════════════════════════════════

DO $$
DECLARE
  v_emp           employees%ROWTYPE;
  v_period_start  DATE := '2026-05-22';
  v_period_end    DATE := '2026-06-21';
